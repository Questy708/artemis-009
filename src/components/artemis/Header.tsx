...
export default function Header({ onMenuClick, goHome, goToPage }: HeaderProps) {
  return (
    <nav className="bg-[#8A0000] text-white h-[50px] flex items-center justify-between px-6 sticky top-0 z-[100] w-full shrink-0 shadow-sm transition-all duration-300">
